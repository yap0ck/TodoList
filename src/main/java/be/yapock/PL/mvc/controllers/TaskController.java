...
import be.yapock.PL.mvc.models.dtos.CategoryDtoIdName;
...
public class TaskController {
    ...
    @GetMapping
    public String findAll(Model model, String login){
        // Récupère la liste de toutes les tâches
        Set<Task> taskList = taskService.getAll(login);
    ...
    public String findAllUnfinished(Model model){
        ...
        Set<Task> taskList = taskService.getAllUnfinished("yapock");

        // Convertit la liste des tâches en une liste de DTO (Data Transfer Objects) pour l'affichage
        Set<TaskShortDTO> dtoList = taskList.stream()
                .map(TaskShortDTO::fromEntity)
    ...
    public String findAllFinished(Model model){
        ...
        Set<Task> taskList = (Set<Task>) taskService.getAllFinished("yapock");
    ...
    public String deleteAllFinished(){
        ...
        taskService.deleteAllFinished("yapock");
